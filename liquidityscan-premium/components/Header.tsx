...
export const Header: React.FC = () => {
  return (
    <header className="w-full border-b border-border bg-background/90 backdrop-blur-xl shrink-0 z-10">
      <div className="flex items-center justify-between px-6 py-4 lg:px-12 max-w-[1600px] mx-auto w-full">
        ...
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-foreground text-lg font-black leading-tight tracking-tighter uppercase select-none">
            LiquidityScan 
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2 text-[10px] uppercase font-bold tracking-widest text-muted bg-surface border border-border px-3 py-1.5 rounded-full">
